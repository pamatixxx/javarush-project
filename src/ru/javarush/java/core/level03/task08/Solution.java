...
public class Solution {
    public static void main(String[] args) {
        ...
        if (age >= 65) {
            System.out.println("Ваша скидка: 20%.");// Если возраст 65 или больше, предоставляем скидку 20%

        } else {
            // Если возраст меньше 65, проверяем наличие клубной карты
            if (hasClubCard.equals("да")) {
                System.out.println("Ваша скидка: 10%."); // Если есть клубная карта, предоставляем скидку 10%

            } else {
                System.out.println("Скидки нет.");// Во всех остальных случаях скидки нет
